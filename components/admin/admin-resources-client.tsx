    ...
    <div className="mx-auto flex max-w-4xl flex-col gap-12">
      <section className="space-y-4">
        ...
        <Text className="text-muted-fg">
          ...
          (same pattern as companies). Growing the catalog afterward happens here by approving submissions
          — or via future inline create/edit in admin.
        </Text>
                  ...
                  <Button
                    ...
                    onPress={() =>
                      void (async () => {
                        ...
                        setLog("");
                        try {
                          await reject({ submissionId: s._id, reason: "Does not fit directory scope" });
                        } catch (err) {
                          setLog(err instanceof Error ? err.message : String(err));
                        } finally {
                          setBusy(false);
